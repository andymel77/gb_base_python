...
class Clothes(ABC):
    @abstractclassmethod
    def get_total_consumption(self, vh):
        pass
...
coat = Coat(13)
print(f'Coat total consumption: {coat.get_total_consumption}')

costume = Costume(1)
print(f'Costume total consumption: {costume.get_total_consumption}')